...
const LAYERS = [
  ...
  { cat: "⚓ Limits & Jurisdiction", id: "limites",
    ...
    // ⚠ VERIFICAR: confirmar que el servicio ArcGIS sigue activo en
    // https://webgis.dgrm.mm.gov.pt/arcgis/rest/services/PSOEM_GEOPORTAL?f=pjson
  ...
  { cat: "🪨 Geology & Bathymetry", id: "recursos_geo",
    ...
    // ⚠ VERIFICAR: confirmar nombre del servicio en
    // https://webgis.dgrm.mm.gov.pt/arcgis/rest/services/PSOEM_GEOPORTAL?f=pjson
  ...
  { cat: "🏭 [EMODnet] Human Activities", id: "emod_cables_esp",
    type: "wms",
    name: "Submarine Cables — Iberian (CICA)",
    desc: "Submarine telecommunication cables in Spanish/Iberian waters (CICA source)",
    url: EMOD_HUM, wmsLayers: "sigcables" },

  { cat: "🏭 [EMODnet] Human Activities", id: "emod_cables_fra",
    type: "wms",
    name: "Submarine Cables — France/Atlantic (SHOM)",
    desc: "Submarine telecommunication cables in French Atlantic waters (SHOM source)",
    url: EMOD_HUM, wmsLayers: "shomcables" },
  ...
  { cat: "🏭 [EMODnet] Human Activities", id: "emod_mpa",
    ...
    desc: "European network of Marine Protected Areas (OSPAR, HELCOM, MAPAMED)",
    // ⚠ VERIFICAR nombre exacto de capa: buscar "protected" en GetCapabilities
    // https://ows.emodnet-humanactivities.eu/wms?SERVICE=WMS&REQUEST=GetCapabilities
