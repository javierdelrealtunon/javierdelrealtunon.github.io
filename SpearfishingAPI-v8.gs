// SpearfishingAPI - Google Apps Script v8
// Guarda sitios por nombre de columna y adjunta fotos con POST de formulario o JSON.
...
function savePhoto_(payload) {
  if (!payload.foto_base64) {
    throw new Error('Falta foto_base64');
  }
